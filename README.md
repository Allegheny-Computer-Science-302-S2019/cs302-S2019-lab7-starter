...
# cs302-S2019-lab7-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the solution for Laboratory 7 in Computer Science 302.
...
This assignment invites a programmer to fully implement a static web site that
...
and `ls` commands to analyze and convert images for your gallery. As before,
...
CSS source code. Instead, you should create and test all of the needed
directories and files. Remember, you can use the `mkdir` command to make a
directory in your GitHub repository. If you have not used this command before,
then you can learn more about it by running the command `man mkdir` in your
terminal window. Briefly, the main checks that GatorGrader performs are for the
existence of certain files (e.g., the screenshot that shows your final web
site). More details about the GatorGrader checks are included later in this
...
laboratories on the course web site. It is critically important that you review
and understand the wireframe of the image gallery that you are tasked with
completing for this assignment, as provided in Figure 1 of the assignment
sheet.
...
directory, and `gallery_submission.png` in the `images` directory. GatorGrader
will also check to ensure that your files do not contain any markers indicating
that your files are not yet complete. Finally, GatorGrader will check to ensure
that you have furnished an answer for each of the technical questions in the
`reflection.md` file in the `writing` directory.
...
you can go to the [Computer Science 302 Lab 7
Starter](https://github.com/Allegheny-Computer-Science-302-S2019/cs302-S2019-lab7-starter)
